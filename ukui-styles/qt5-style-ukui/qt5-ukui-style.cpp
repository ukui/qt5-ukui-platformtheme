...
const QStringList Qt5UKUIStyle::useDarkPaletteList() const
{
...
const QStringList Qt5UKUIStyle::useDefaultPaletteList() const
{
    //use light palette
    QStringList l;
    l<<"kybackup";
...
const QStringList Qt5UKUIStyle::useTransparentButtonList() const
{
